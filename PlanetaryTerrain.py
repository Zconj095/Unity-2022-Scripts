...
class Atmosphere:
    ...
    def init_material(self, mat):
        ...
        mat.set_vector("v3LightPos", Vector3(*self.m_sun.transform.position) * -1.0)
        mat.set_vector("v3Translate", self.planet.scaled_space_copy.transform.position if self.scaled_space_copy else self.planet.transform.position)
...
class Quad:
    ...
    def get_neighbors(self):
        ...
        self.configuration = EdgeConfiguration.None
...
class Node:
    class InputAttribute:
        def __init__(self, backing_value=ShowBackingValue.Unconnected, connection_type=ConnectionType.Multiple, type_constraint=TypeConstraint.None, instance_port_list=False):
    ...
    def add_instance_input(self, node_type, connection_type=ConnectionType.Multiple, type_constraint=TypeConstraint.None, field_name=None):
        return self.add_instance_port(node_type, NodePort.IO.Input, connection_type, type_constraint, field_name)

    def add_instance_output(self, node_type, connection_type=ConnectionType.Multiple, type_constraint=TypeConstraint.None, field_name=None):
        return self.add_instance_port(node_type, NodePort.IO.Output, connection_type, type_constraint, field_name)

    def add_instance_port(self, node_type, direction, connection_type=ConnectionType.Multiple, type_constraint=TypeConstraint.None, field_name=None):
