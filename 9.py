...
from bpy.props import PointerProperty, BoolProperty, FloatProperty, StringProperty, IntProperty, FloatVectorProperty

class EnviroFlatCloudsModuleProperties(PropertyGroup):
    # Cirrus Clouds properties
    use_cirrus_clouds: BoolProperty(name="Use Cirrus Clouds")
    cirrus_clouds_tex: StringProperty(name="Cirrus Clouds Texture")
    cirrus_clouds_alpha: FloatProperty(name="Cirrus Clouds Alpha")
    cirrus_clouds_coverage: FloatProperty(name="Cirrus Clouds Coverage")
    cirrus_clouds_color_power: FloatProperty(name="Cirrus Clouds Color Power")
    cirrus_clouds_color: FloatVectorProperty(name="Cirrus Clouds Color", size=4)
    cirrus_clouds_wind_intensity: FloatProperty(name="Cirrus Clouds Wind Intensity")
    
    # 2D Clouds properties
    use_flat_clouds: BoolProperty(name="Use Flat Clouds")
    ...
    flat_clouds_light_color: FloatVectorProperty(name="Flat Clouds Light Color", size=4)
    flat_clouds_ambient_color: FloatVectorProperty(name="Flat Clouds Ambient Color", size=4)
    flat_clouds_light_intensity: FloatProperty(name="Flat Clouds Light Intensity")
    flat_clouds_ambient_intensity: FloatProperty(name="Flat Clouds Ambient Intensity")
    flat_clouds_absorbtion: FloatProperty(name="Flat Clouds Absorbtion")
    flat_clouds_hg_phase: FloatProperty(name="Flat Clouds HG Phase")
    flat_clouds_coverage: FloatProperty(name="Flat Clouds Coverage")
    flat_clouds_density: FloatProperty(name="Flat Clouds Density")
    flat_clouds_altitude: FloatProperty(name="Flat Clouds Altitude")
    flat_clouds_tonemapping: BoolProperty(name="Flat Clouds Tonemapping")
    flat_clouds_base_tiling: FloatProperty(name="Flat Clouds Base Tiling")
    flat_clouds_detail_tiling: FloatProperty(name="Flat Clouds Detail Tiling")
    flat_clouds_wind_intensity: FloatProperty(name="Flat Clouds Wind Intensity")
    flat_clouds_detail_wind_intensity: FloatProperty(name="Flat Clouds Detail Wind Intensity")
...
class ENV_PT_flat_clouds_module_panel(Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(enviro_props, "cirrus_clouds_color")
