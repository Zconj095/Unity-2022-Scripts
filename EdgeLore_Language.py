...
POSITION = "LOCATION"
PROTON = "A SUBATOMIC PARTICLE WITH A POSITIVE ELECTRIC CHARGE OF A SET ELEMENTARY.CHARGE AND A MASS AMOUNT STATED AND GIVEN WITH LESS THAN A NEUTRON"
...
MATHEMATICS1 EQUALS
    AN AREA OF KNOWLEDGE THAT INCLUDES SPECIFIC FIELDS OF INTEREST KNOWN AS NUMBERS
    AN AREA OF KNOWLEDGE THAT INCLUDES SPECIFIC FIELDS OF INTEREST KNOWN AS FORMULAS
    AN AREA OF KNOWLEDGE THAT INCLUDES SPECIFIC FIELDS OF INTEREST KNOWN AS STRUCTURES THAT HAVE MANY SIMILAR
    
    AN AREA OF KNOWLEDGE THAT INCLUDES SPECIFIC FIELDS OF INTEREST KNOWN AS ASPECTS SHAPES AND SPACES IN WHICH THE SHAPES IS CONTAINED AND QUANTITIES